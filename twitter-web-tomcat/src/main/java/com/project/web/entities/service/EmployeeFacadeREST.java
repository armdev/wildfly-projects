 ...
 */
package com.project.web.entities.service;

import com.project.web.entities.Employee;
 ...
 */
@Stateless
@Path("com.project.web.entities.employee")
public class EmployeeFacadeREST extends AbstractFacade<Employee> {

    @PersistenceContext(unitName = "com.project_twitter-web_war_1.0-SNAPSHOTPU")
